...
Write-Host "📌 Directory Path Location: $PSScriptRoot" -ForegroundColor Cyan
...
python "$PSScriptRoot\generate_vol_data.py"
...
python "$PSScriptRoot\options_calibration.py"
if ($LASTEXITCODE -ne 0) { 
...
# Asynchronously fire up the default browser session window after a minor 2.5 second thread sleep delay
